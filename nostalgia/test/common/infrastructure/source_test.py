...
class ExampleSource(Source):
    ...
    def ingest(self, delta_data, **kwargs):
        self.resolve_filename = MagicMock(return_value="../../resources/test_data/example_source/ingested_data.json")
        file = self.read_file("")
        return file
...
class SourceTest(unittest.TestCase):
    ...
    def test_sdf_has_required_aspects(self):
        self.assertEqual(3, 3)

    def test_sdf_has_category(self):
        self.assertEqual(3, 3)

    def test_sdf_infers_time(self):
        self.assertEqual(3, 3)

    def test_sdf_has_listed_aspects(self):
        self.assertEqual(3, 3)